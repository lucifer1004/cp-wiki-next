...
const sidebars = {
  ...
  dataStructureSidebar: [
    ...
    },
    {
      ...
      label: "进阶数据结构",
      items: [
        "data-structure/balanced-binary-search-tree/README",
        "data-structure/disjoint-sets-union/README",
        "data-structure/segment-tree/README",
      ],
    },
  ],
  graphSidebar: [
